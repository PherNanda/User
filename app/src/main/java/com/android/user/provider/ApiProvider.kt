package com.android.user.provider
            ...
            .addNetworkInterceptor { chain ->
                chain.proceed(
                    chain.request()
                        ...
                        .header(
                            "User-Agent",
                            "Android:${BuildConfig.USER_APP_NAME} Version:${BuildConfig.VERSION_NAME} Package:${BuildConfig.PACKAGE_NAME} Framework:${TAG}/4.4.0"
                        )
                        .build()
                )
            }
